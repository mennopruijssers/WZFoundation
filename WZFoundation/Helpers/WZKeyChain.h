...
//  WZFoundation
//
//  Created by Menno on 15-03-12. Based on WZKeyChain
...
typedef enum {
	/** No error. */
	WZKeyChainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	WZKeyChainErrorBadArguments = -1001,
	
	/** There was no password. */
	WZKeyChainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	WZKeyChainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	WZKeyChainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	WZKeyChainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	WZKeyChainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	WZKeyChainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	WZKeyChainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	WZKeyChainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	WZKeyChainErrorFailedToDecode = errSecDecode
} WZKeyChainErrorCode;

extern NSString *const kWZKeyChainErrorDomain;

/** Account name. */
extern NSString *const kWZKeyChainAccountKey;
 ...
 */
extern NSString *const kWZKeyChainCreatedAtKey;

/** Item class. */
extern NSString *const kWZKeyChainClassKey;

/** Item description. */
extern NSString *const kWZKeyChainDescriptionKey;

/** Item label. */
extern NSString *const kWZKeyChainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kWZKeyChainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kWZKeyChainWhereKey;
...
/**
 ...
 WZKeyChain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in WZKeyChain.h for a list of keys that can be used when accessing the
